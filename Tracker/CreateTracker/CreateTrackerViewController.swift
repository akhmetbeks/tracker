...
extension CreateTrackerViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: CreateTrackerCell.identifier, for: indexPath)
        guard let createTrackerCell = cell as? CreateTrackerCell else {
